...
<div class="dol-text dol-text-base dol-text-gray-500 dol-mb-3">
	<?php printf( esc_html__( 'Quickly run tasks across multiple %s with the click of a button! Please select the action you would like to run using the form below.', 'dollie' ), dollie()->string_variants()->get_site_type_plural_string() ); ?>
</div>
