				...
				<div class="dol-sites-item <?php echo esc_attr( $list_item_type ); ?>">
					<div class="dol-sites-item-inner">
						...
						<div class="dol-sites-controls">
							<a class="dol-inline-block dol-text-sm dol-text-white dol-font-semibold dol-bg-blue-500 dol-rounded dol-px-3 dol-py-2 hover:dol-text-white hover:dol-bg-blue-600"
							...
							if ( ! empty( $login_link ) ) :
								?>
								<a class="dol-inline-block dol-text-sm dol-text-white dol-font-semibold dol-bg-gray-600 dol-rounded dol-px-3 dol-py-2 hover:dol-text-white hover:dol-bg-gray-700"
