    ...
    <div class="dol-flex dol-justify-center dol-items-center dol-w-full dol-h-full">
        <div class="dol-bg-white dol-rounded dol-w-2/4 dol-overflow-hidden">
            <div class="dol-shadow-sm dol-bg-gray-100">
                <div class="dol-flex dol-justify-between dol-items-center">
                    <div class="dol-bg-gray-500 dol-text-white dol-font-medium dol-flex dol-flex-row">
                        <div class="dol-tab-action dol-tab-action-initial dol-tab-active dol-text-md dol-cursor-pointer dol-px-8 dol-py-3"
                             data-tab-name="#dol-bulk-actions">
							<?php esc_html_e( 'Bulk Actions', 'dollie' ); ?>
                        </div>
                        <div class="dol-tab-action dol-text-md dol-cursor-pointer dol-px-8 dol-py-3"
                             data-tab-name="#dol-scheduled-actions" data-tab-callback="getScheduledActions">
							<?php esc_html_e( 'Scheduled Actions', 'dollie' ); ?>
                        </div>
                        <div class="dol-tab-action dol-text-md dol-cursor-pointer dol-px-8 dol-py-3"
                             data-tab-name="#dol-create-schedule" data-tab-callback="getScheduleTemplate">
            ...
            <div id="dol-bulk-actions" class="dol-tab-inner dol-tab-active dol-p-8">
                ...
                <div class="">
                    <select name="action"
                            class="dol-action-list dol-bg-white dol-rounded dol-px-4 dol-py-2 dol-border-solid dol-border-gray-300 dol-text-base dol-text-gray-700 focus:dol-border-gray-400 focus:dol-outline-none">
                ...
                <div class="dol-mt-4">
                    <button type="button"
                            class="dol-modal-submit dol-apply-action dol-px-4 dol-py-2 dol-bg-primary-500 hover:dol-bg-primary-600 dol-border-0 dol-rounded dol-text-white dol-text-sm focus:dol-outline-none focus:dol-bg-primary-600"
            ...
            <div id="dol-scheduled-actions" class="dol-tab-inner dol-p-8">
                ...
                <div id="dol-loading-history" class="dol-hidden"
                    ...
                    <div class="dol-spinner dol-flex dol-items-center dol-text-gray-500">
                        <svg class="dol-animate-spin dol-mr-3 dol-h-5 dol-w-5" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="dol-flex dol-justify-center dol-items-center dol-w-full dol-h-full">
        <div class="dol-bg-white dol-rounded dol-w-2/6 dol-p-6">
            ...
            <div class="dol-g">
                <div class="">
                    <label for="per-page"
                           class="dol-font-bold dol-uppercase dol-mb-1 dol-text-xs dol-text-gray-600"><?php esc_html_e( 'Per page', 'dollie' ); ?></label>
                    <select id="per-page"
                            class="dol-w-20 dol-bg-white dol-rounded dol-px-3 dol-py-1 dol-border-solid dol-border-gray-300 dol-text-sm dol-text-gray-700 focus:dol-border-gray-400 focus:dol-outline-none">
            ...
            <div class="dol-mt-4">
                <button type="button"
                        class="dol-modal-submit dol-apply-filters dol-px-4 dol-py-2 dol-bg-primary-500 hover:dol-bg-primary-600 dol-border-0 dol-rounded dol-text-white dol-text-sm focus:dol-outline-none focus:dol-bg-primary-600">
