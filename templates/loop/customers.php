...
<div class="dol-mb-6 dol-widget-customer-search">
	<div class="dol-flex dol-flex-wrap md:dol-justify-between">
		...
		<div class="dol-relative dol-w-full md:dol-w-auto">
			...
			<input type="text" name="customer_search" class="dol-search-input dol-search-customer dol-w-full md:dol-w-64" data-list-type="<?php echo esc_attr($view_type); ?>" data-permalink="<?php echo esc_attr($query_data['permalink']); ?>" data-search-term="" placeholder="<?php esc_html_e('Search for a Customer...', 'dollie'); ?>">
		</div>
	</div>
</div>
				...
				<div class="dol-customers-item <?php echo esc_attr($list_item_type); ?>">
					<div class="dol-customers-item-inner <?php do_action('dol_add_widget_classes'); ?> dol-divide-y dol-divide-gray-200">
						...
						<div class="dol-customers-controls">
							<a class="dol-inline-block dol-text-sm dol-text-white dol-font-semibold dol-bg-primary dol-rounded dol-px-3 dol-py-2 hover:dol-text-white hover:dol-bg-primary-600" href="<?php echo get_edit_user_link($customer->ID);?>">
								<i class="fas fa-cog"></i>
								<span class="dol-ml-1"><?php esc_html_e('Manage Customer', 'dollie'); ?></span>
							</a>


							<a class="dol-inline-block dol-text-sm dol-text-gray-500 dol-font-semibold dol-bg-gray-200 dol-rounded dol-px-3 dol-py-2 hover:dol-text-white hover:dol-bg-secondary" href="<?php echo dollie()->get_sites_page_url();?>?customer=<?php echo $customer->ID;?>">
