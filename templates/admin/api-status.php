...
<?php if ( $token ) : ?>
	<p><?php esc_html_e( 'This is the token that links this site and your account to the Dollie Private Cloud.', 'dollie' ); ?></p>
	...
	<a href="<?php echo esc_url( add_query_arg( 'disconnect_dollie', 1 ) ); ?>" class="button button-large">
		<?php esc_html_e( 'Disconnect from Dollie Private Cloud', 'dollie' ); ?>
	</a>
...
<?php else : ?>
	<div class="notice dollie-notice">
		<?php esc_html_e( 'This Hub is not connected to the Dollie Private Cloud. Please follow the instructions at the top of the page to securely connect to Dollie Private Cloud.', 'dollie' ); ?>
	</div>
<?php endif; ?>
