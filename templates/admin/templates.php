...
?>
<div class="dol-mr-6 dol-mt-6 dol-ml-3">

    <div class="dol-container dol-mx-auto dol-bg-white dol-rounded dol-shadow-lg dol-overflow-hidden dol-mb-6">
			...
			<?php foreach ( $templates as $template ) : ?>
                <div class="dol-rounded dol-shadow hover:dol-shadow-lg dol-overflow-hidden">
                    <div class="dol-aspect-w-16 dol-aspect-h-9">
                        <img class="dol-w-full dol-object-cover" src="<?php echo esc_url( $template['image'] ); ?>">
                    </div>
