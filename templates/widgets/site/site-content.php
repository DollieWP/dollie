		...
		<div class="hero-inner">
			<div class="content content-blank">
				<div class="py-30 text-center">
					...
					<p class="pl-100 pr-100 h5 font-size-large text-gray mt-20 mb-20">
				...
				<div class="py-30 text-center">
					...
					<?php else : ?>
						<div class="mb-20">
							<h2 class="text-white">
								<i class="fab fa-wordpress"></i>
								Sorry, there was an error launching your site.</h2>
						</div>
						<p class="pl-100 pr-100 h5 font-size-large text-gray mt-20 mb-20">
...
<?php elseif ( 'pending' === $status ) : ?>
	...
	<div class="dol-py-32 dol-flex dol-flex-col dol-items-center dol-justify-center">
		<svg class="dol-animate-spin dol-h-16 dol-w-16 dol-text-flame-600"
