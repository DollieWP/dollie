<form method="POST" action="">
	<div class="dol-flex dol-flex-wrap dol--mx-2">
		<div class="dol-w-4/12 dol-px-2">
			<label for="dol-ns-hostname" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'Hostname' ); ?></label>
			<input type="text" name="ns-hostname" id="dol-ns-hostname" placeholder="<?php esc_html_e( 'Enter @ or hostname', 'dollie' ); ?>">
		</div>
		<div class="dol-w-4/12 dol-px-2">
			<label for="dol-ns-alias" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'Will redirect to' ); ?></label>
		...
		<div class="dol-w-2/12 dol-px-2">
			<label for="dol-ns-ttl" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'TTL (seconds)' ); ?></label>
