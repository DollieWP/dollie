<form method="POST" action="">
	<div class="dol-flex dol-flex-wrap dol--mx-2">
		<div class="dol-w-5/12 dol-px-2">
			<label for="dol-srv-hostname" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'Hostname' ); ?></label>
			<input type="text" name="srv-hostname" id="dol-srv-hostname" placeholder="<?php esc_html_e( 'e.g. _service._protocol', 'dollie' ); ?>">
		</div>
		<div class="dol-w-5/12 dol-px-2">
			<label for="dol-svr-redirect" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'Will direct to' ); ?></label>
		...
		<div class="dol-w-2/12 dol-px-2">
			<label for="dol-svr-port" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'Port' ); ?></label>
	...
	<div class="dol-flex dol-flex-wrap dol--mx-2 dol-mt-2">
		<div class="dol-w-2/12 dol-px-2">
			<label for="dol-srv-priority" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'Priority' ); ?></label>
			<input type="text" name="srv-priority" id="dol-srv-priority" placeholder="<?php esc_html_e( 'e.g. 10', 'dollie' ); ?>">
		</div>
		<div class="dol-w-2/12 dol-px-2">
			<label for="dol-srv-weight" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'Weight' ); ?></label>
			<input type="text" name="srv-weight" id="dol-srv-weight" value="" placeholder="<?php esc_html_e( 'e.g. 100', 'dollie' ); ?>">
		</div>
		<div class="dol-w-2/12 dol-px-2">
			<label for="dol-srv-ttl" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'TTL (seconds)' ); ?></label>
