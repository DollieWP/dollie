<form method="POST" action="">
	<div class="dol-flex dol-flex-wrap dol--mx-2">
		<div class="dol-w-5/12 dol-px-2">
			<label for="dol-caa-hostname" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'Hostname' ); ?></label>
		...
		<div class="dol-w-4/12 dol-px-2">
			<label for="dol-caa-domain" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'Authority granted for' ); ?></label>
		...
		<div class="dol-w-3/12 dol-px-2">
			<label for="dol-caa-tag" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'Tag' ); ?></label>
	...
	<div class="dol-flex dol-flex-wrap dol--mx-2 dol-mt-2">
		<div class="dol-w-2/12 dol-px-2">
			<label for="dol-caa-flags" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'Flags' ); ?></label>
			<input type="text" name="caa-flags" id="dol-caa-flags" value="0" placeholder="<?php esc_html_e( 'e.g. 0', 'dollie' ); ?>">
		</div>
		<div class="dol-w-2/12 dol-px-2">
			<label for="dol-caa-ttl" class="dol-text-xs dol-font-bold dol-uppercase dol-mb-2"><?php esc_html_e( 'TTL (seconds)' ); ?></label>
