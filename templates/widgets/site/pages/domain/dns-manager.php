<?php if ( 'active' === $dns_manager ) : ?>
	...
	<div class="dol-rounded dol-overflow-hidden dol-shadow dol-mb-6">
		...
		<div class="dol-p-4 lg:dol-px-8 lg:dol-py-6">
			<h5 class="dol-p-0 dol-m-0 dol-mb-4 dol-text-lg dol-font-bold">
				<i class="far fa-file-alt dol-mr-2"></i>
			...
			<h5 class="dol-p-0 dol-mt-6 dol-mb-4 dol-text-lg dol-font-bold">
				<i class="far fa-list-alt dol-mr-2"></i>
