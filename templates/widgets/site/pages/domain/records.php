		...
		<?php foreach ($records['records'] as $record) : ?>
			<div class="dol-dns-record-item dol-flex dol-flex-wrap dol-border-0 dol-border-b dol-border-solid dol-border-gray-100 dol-text-gray-600 dol-relative">
				...
				<div class="dol-w-1/12 dol-p-2 dol-text-center">
					<span class="dol-dns-record-remove dol-cursor-pointer dol-text-gray-500 hover:dol-text-secondary-600" data-ajax-url="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('dollie_remove_record')); ?>" data-record-id="<?php echo esc_attr($record['id']); ?>" data-container-id="<?php echo esc_attr($container_id); ?>">
