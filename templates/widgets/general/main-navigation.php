...
<ul class="dol-list-none dol-p-0 dol-m-0">
	<li class="dol-mb-4">
		<a href="<?php echo dollie()->get_launch_page_url(); ?>"
		   class="dol-nav-btn dol-nav-btn-primary dol-font-bold <?php echo esc_attr( $active_class['launch-site'] ); ?>">
	...
	<li class="dol-mb-1">
		<a href="<?php echo dollie()->get_dashboard_page_url(); ?>"
		   class="dol-nav-btn dol-nav-btn-secondary dol-font-bold <?php echo esc_attr( $active_class['dashboard'] ); ?>">
	...
	<li class="dol-m-0">
		<a href="<?php echo dollie()->get_sites_page_url(); ?>"
		   class="dol-nav-btn dol-nav-btn-secondary dol-font-bold <?php echo esc_attr( $active_class['sites'] ); ?>">
