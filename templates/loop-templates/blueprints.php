...
?>
<li class="dol-m-0 dol-col-span-1 dol-flex dol-flex-col dol-bg-white dol-rounded-lg dol-shadow dol-divide-y dol-divide-gray-200">
	<div class="dol-flex-1 dol-flex dol-flex-col dol-p-5">
		<img class="dol-w-100 dol-h-100 dol-flex-shrink-0 dol-mx-auto dol-bg-black " src="<?php echo $image; ?>" alt="">
		...
		<dl class="dol-mt-1 dol-flex-grow dol-flex dol-flex-col dol-justify-between">
			<dd class="dol-text-gray-500 dol-text-l"><?php echo get_post_meta( get_the_ID(), 'wpd_installation_blueprint_description', true ); ?></dd>
		</dl>
	</div>
	<div>
		<div class="dol--mt-px dol-flex dol-divide-x dol-divide-gray-200">
			<div class="dol-w-0 dol-flex-1 dol-flex">
				...
				<a target="_blank"
				   class="dol-relative dol--mr-px dol-w-0 dol-flex-1 dol-inline-flex dol-items-center dol-justify-center dol-py-4 dol-text-sm dol-text-gray-700 dol-font-medium dol-border dol-border-transparent dol-rounded-bl-lg hover:dol-text-gray-500"
				   href="<?php echo esc_url( $path ); ?>">
			...
			<div class="dol--ml-px dol-w-0 dol-flex-1 dol-flex">
				<a data-id="<?php echo get_the_ID(); ?>"
				   class="dol-relative dol-w-0 dol-flex-1 dol-inline-flex dol-items-center dol-justify-center dol-py-4 dol-text-sm dol-text-gray-700 dol-font-medium dol-border dol-border-transparent dol-rounded-br-lg hover:dol-text-gray-500"
				   href="<?php echo esc_url( $checkout_link ); ?>">
					<?php if ( ! empty( $launch_button_text ) ) { ?>
						<?php echo $launch_button_text; ?> <i class="fal fa-rocket pr-2"></i>
					<?php } else { ?>
