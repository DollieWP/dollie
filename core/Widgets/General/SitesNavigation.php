	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .dol-nav-btn .dol-nav-btn-secondary' => 'color: {{VALUE}}; fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dol-nav-btn.dol-nav-btn-secondary:hover,
					{{WRAPPER}} .dol-nav-btn.dol-nav-btn-secondary,
					{{WRAPPER}} .dol-nav-btn.dol-nav-btn-secondary.highlighted,
					{{WRAPPER}} .dol-nav-btn.dol-nav-btn-secondary:focus' => 'color: {{VALUE}}; fill: {{VALUE}};',
				],
				'condition' => [
					'pointer!' => 'background',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dol-nav-btn.dol-nav-btn-secondary:hover,
					{{WRAPPER}} .dol-nav-btn.dol-nav-btn-secondary.elementor-item-active,
					{{WRAPPER}} .dol-nav-btn.dol-nav-btn-secondary.highlighted,
					{{WRAPPER}} .dol-nav-btn.dol-nav-btn-secondary:focus' => 'color: {{VALUE}}',
				],
				'condition' => [
					'pointer' => 'background',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .dol-nav-btn.dol-nav-btn-secondary.elementor-item-active' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dol-nav-btn.dol-nav-btn-secondary' => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dol-nav-btn.dol-nav-btn-secondary' => 'padding-top: {{SIZE}}{{UNIT}}; padding-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
