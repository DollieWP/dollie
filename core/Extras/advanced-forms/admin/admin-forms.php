...
class AF_Admin_Forms {
	...
	function __construct() {
		...
		add_filter( 'acf/prepare_field/name=form_shortcode_message', [ $this, 'display_form_shortcode' ], 10, 1 );
		add_action( 'save_post', [ $this, 'add_form_key' ], 10, 3 );
		add_action( 'acf/init', [ $this, 'register_fields' ], 10, 0 );
		add_action( 'media_buttons', [ $this, 'add_wysiwyg_content_field_inserter' ], 10, 1 );
		add_action( 'admin_footer', [ $this, 'add_forms_sidebar' ], 10, 0 );

		add_action( 'post_submitbox_start', [ $this, 'add_actions' ], 10, 1 );

		add_filter( 'manage_af_form_posts_columns', [ $this, 'manage_columns' ], 10, 1 );
		add_action( 'manage_af_form_posts_custom_column', [ $this, 'custom_columns_content' ], 10, 2 );
	...
	function add_fields_meta_box() {
		...
		add_meta_box( 'af_form_fields', __( 'Fields', 'advanced-forms' ), [ $this, 'fields_meta_box_callback' ], 'af_form', 'normal', 'default', null );
