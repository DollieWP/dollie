...
<section class="dol-grid dol-grid-cols-1 md:dol-grid-cols-2 dol-gap-4">
	<div class="dol-p-6 dol-bg-white dol-shadow dol-overflow-hidden sm:dol-rounded-md">
		<h4 class="dol-mt-0 dol-mb-2 dol-font-bold dol-text-xl"><?php esc_html_e( 'Deploy Site', 'dollie' ); ?></h4>
		<div class="dol-text-gray-600 dol-mb-4 dol-text-sm">
			<?php esc_html_e( 'Deploy your next site in minutes. Go to the launch form by pressing the button below.', 'dollie' ); ?>
		</div>
	...
	<div class="dol-p-6 dol-bg-white dol-shadow dol-overflow-hidden sm:dol-rounded-md">
	<h4 class="dol-mt-0 dol-mb-2 dol-font-bold dol-text-xl"><?php esc_html_e( 'Deploy Blueprint', 'dollie' ); ?></h4>
		<div class="dol-text-gray-600 dol-mb-4 dol-text-sm">
