						...
						<div class="dol-min-w-0 dol-flex-1 dol-flex dol-items-center">
							...
							<div class="dol-min-w-0 dol-flex-1 dol-px-4">
								<div>
									...
									<p class="dol-mt-2 dol-flex dol-items-center dol-text-sm dol-text-gray-500">
										<span class="dol-truncate"><?php esc_html_e( 'Access Groups control what your customers/client are allowed to do inside your Hub.', 'dollie' ); ?>
												<br><?php esc_html_e( 'You then link an Access Group to a eCommerce or Membership solution like WooCommerce or Paid Memberships Pro', 'dollie' ); ?>
										<?php esc_html_e( '', 'dollie' ); ?>
										</span>
									</span>
