	...
	<h1 class="dol-font-bold"><span class="dol-opacity-60 dol-mr-2">Theme</span><?php esc_html_e( 'Which Theme Would You Like to use for building your Hub?', 'dollie-setup' ); ?></h1>
	<h4>Important - Dollie works perfectly with any WordPress Theme, so if you love your current theme, you can keep using that.</h4>
