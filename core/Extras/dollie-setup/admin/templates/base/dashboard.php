                ...
                <div class="dol-p-6 dol-bg-white">
                    <div class="sm:dol-flex sm:dol-items-center sm:dol-justify-between">
                        ...
                        <div class="dol-mt-4 dol-text-center sm:dol-mt-0 sm:dol-pt-1 sm:dol-text-left dol-p-4"
                            ...
                            <img class="dol-w-48 dol-h-auto dol-mx-auto dol-rounded-md dol-mb-4"
                                 src="https://getdollie.com/wp-content/uploads/2020/12/dollie-logo.png"
                                 alt="">
                        ...
                        <div class="dol-flex-shrink-0s dol-block">
                            <img class="dol-w-100 dol-h-auto dol-mx-auto dol-rounded-md"
                                 src="<?php echo esc_url( DOLLIE_ASSETS_URL . 'wizard/hub-welcome.png' ); ?>"
                                 alt="">
                        </div>
                    </div>
                    <hr>
