<p><?php esc_html_e( 'Dollie Setup OpenLab is designed for teaching, learning, and collaboration. It allows faculty members, departments, and entire institutions to create commons spaces for open learning.', 'dollie-setup' ); ?></p>

<p><?php printf( __( 'Dollie Setup OpenLab is a collaboration between <a href="%1$s" target="_blank">The Graduate Center, CUNY</a> and <a href="%2$s" target="_blank">New York City College of Technology</a>. It is being created with funding from the National Endowment for the Humanities\' <a href="%3$s" target="_blank">Office of Digital Humanities</a>.', 'dollie-setup' ), 'https://www.gc.cuny.edu/', 'https://www.citytech.cuny.edu/', 'https://www.neh.gov/divisions/odh' ); ?></p>
...
<li><a href="http://commonsinabox.org/dollie_setup-openlab-overview" target="_blank"><?php _e( 'Documentation', 'dollie-setup' ); ?></a></li>
</ul>
