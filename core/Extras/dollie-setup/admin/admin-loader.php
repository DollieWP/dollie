...
?>
	...
	public function admin_menu()
	{
		...
		$subpage = add_submenu_page(
			'dollie_setup',
			__('Dollie Setup Dashboard', 'dollie-setup'),
								...
								<div class="plugin-card plugin-card-<?php echo sanitize_html_class(dollie_setup_get_package_prop('name', $package)); ?>" style="width:100%; margin-left:0;">
									...
									<div class="plugin-card-bottom">
										...
										<div class="column-compatibility">
											<?php if ($incompatible) : ?>
												<span class="compatibility-incompatible"><?php _e('Requires WordPress Multisite.', 'dollie-setup'); ?> <?php printf('<a href="%1$s" target="_blank">%2$s</a>', 'https://codex.wordpress.org/Create_A_Network', esc_html__(
		...
		if (!empty($requirements['Dollie Setup']['core'])) {
			...
			<div id="dollie_setup-upgrades" class="secondary-panel">
				...
				<div class="login postbox">
					<div class="message">
						<p><?php printf(__('Dollie Setup %s requires WordPress %s', 'dollie-setup'), dollie_setup_get_version(), $version); ?>
							<br />
