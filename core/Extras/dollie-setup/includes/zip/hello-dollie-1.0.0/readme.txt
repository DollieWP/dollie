...
Contributors: Bowe Frankema, Dollie Team, elemntor, KingYes, ariel.k, jzaltzberg, mati1000, bainternet
...
A lightweight, plain-vanilla theme for Dollie & The Elementor page builder.

****** is distributed under the terms of the GNU GPL v3 or later.

== Description ==

A basic, plain-vanilla, lightweight theme, best suited for building your platform using Dollie & The Elementor page builder.

This theme resets the WordPress environment and prepares it for smooth operation.
...
To customize your site's appearance, simply use Dollie & ***Elementor***.
...
* `hello_dollie_enqueue_style`                 enqueue style
* `hello_dollie_enqueue_theme_style`           load theme-specific style (default: load)
* `hello_dollie_load_textdomain`               load theme's textdomain
* `hello_dollie_register_menus`                register the theme's default menu location
* `hello_dollie_add_theme_support`             register the various supported features
* `hello_dollie_add_woocommerce_support`       register woocommerce features, including product-gallery zoom, swipe & lightbox features
* `hello_dollie_register_elementor_locations`  register elementor settings
* `hello_dollie_content_width`                 set default content width to 800px
* `hello_dollie_page_title`                    show\hide page title (default: show)
* `hello_dollie_viewport_content`              modify `content` of `viewport` meta in header

== Frequently Asked Questions ==

**Does this theme support any plugins?**

includes additional support and styling for WooCommerce.
...
* Tweak: Remove header tags with `hello_dollie_page_title` filter
...
* New: Added `hello_dollie_page_title` filter for show\hide page title
* New: Added `hello_dollie_enqueue_theme_style` filter for enqueue theme-specific style
...
= 2.0.2 - 2019-05-13 =
* Tweak: Added `hello_dollie_content_width` filter, as per WordePress best practice
...
* Tweak: Change functions.php methods names prefix from `hello_dollie_theme_` to `hello_dollie_`
