...
function ocdi_import_files_string()
{
	return [
		[
			'import_file_name'           => 'Vendor Example Content',
			'categories'                 => ['Category 1', 'Category 2'],
			'local_import_file'            => DOLLIE_PATH . 'core/Extras/dollie-setup/includes/vendor/defaults/dollie-products.xml',
...
function ocdi_plugin_page_setup($default_settings)
{
	...
	$default_settings['menu_title']  = esc_html__('Setup Your SaaS Platform', 'one-click-demo-import');
