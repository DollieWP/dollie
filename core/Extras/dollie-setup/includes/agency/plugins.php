 ...
 * @since 1.1.0
 */
class Dollie_Setup_Plugins_Agency {
	/**
	 * Initiator.
	 *
	 * @since 1.1.0
	...
	protected static function register_required_plugins( $instance ) {
		...
		call_user_func(
			...
			array(
				...
				'version'                  => '5.12.2',
				'documentation_url'        => 'https://dashboard.getdollie.com/?s=WooCommerce&ht-kb-search=1&lang=',
		...
		call_user_func(
			...
			array(
				...
				'version'                  => '3.5.5',
				'documentation_url'        => 'https://dashboard.getdollie.com/?s=Elementor&ht-kb-search=1&lang=',
