 ...
 * @since 1.1.0
 */
class Dollie_Setup_Plugins_OpenLab {
	/**
	 * Initiator.
	 *
	 * @since 1.1.0
	...
	protected static function register_required_plugins( $instance ) {
		...
		call_user_func(
			...
			array(
				...
				'dollie_setup_name'        => __( 'BuddyPress', 'dollie-setup' ),
				'dollie_setup_description' => __( 'BuddyPress provides the core functionality of Dollie Setup, including groups and user profiles.', 'dollie-setup' ),
				'version'                  => '9.2.0',
		...
		call_user_func(
			...
			array(
				...
				'dollie_setup_name'        => __( 'OpenLab Core', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Core functionality for DOLLIE_SETUP-OpenLab.', 'dollie-setup' ),
				'version'                  => '1.3.2',
		...
		call_user_func(
			...
			array(
				'plugin_name'              => 'bbPress',
				'dollie_setup_name'        => __( 'bbPress Forums', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Sitewide and group-specific discussion forums.', 'dollie-setup' ),
				'version'                  => '2.6.9',
		...
		call_user_func(
			...
			array(
				...
				'dollie_setup_name'        => __( 'Docs', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Allows your members to collaborate on wiki-style Docs.', 'dollie-setup' ),
				'version'                  => '2.1.6',
		...
		call_user_func(
			...
			array(
				...
				'dollie_setup_name'        => __( 'Docs in Group', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Put BuddyPress Docs into the Group context.', 'dollie-setup' ),
				'version'                  => '1.0.2',
				'depends'                  => 'BuddyPress (>=1.5)',
		...
		call_user_func(
			...
			array(
				...
				'dollie_setup_name'        => __( 'Group Documents', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Allow your members to attach documents to groups.', 'dollie-setup' ),
				'version'                  => '1.12.3',
		...
		call_user_func(
			...
			array(
				...
				'dollie_setup_name'        => __( 'Group Email Subscription', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Allows your community members to receive email notifications of activity within their groups.', 'dollie-setup' ),
				'depends'                  => 'BuddyPress (>=1.5)',
				'version'                  => '4.0.1',
		...
		call_user_func( $instance, array(
			...
			'dollie_setup_name'         => __( 'BP Customizable Group Categories', 'dollie-setup' ),
			'dollie_setup_description'  => __( 'Categories for BuddyPress Groups', 'dollie-setup' ),
			'version'           => '1.0.0',
			'download_url'      => '', // @todo
			'documentation_url' => '', // @todo
			'network'           => false
		...
		*/
		...
		call_user_func(
			...
			array(
				...
				'dollie_setup_name'        => __( 'Invite Anyone', 'dollie-setup' ),
				'dollie_setup_description' => __( 'An enhanced interface for inviting existing community members to groups, as well as a powerful tool for sending invitations, via email, to potential members.', 'dollie-setup' ),
				'version'                  => '1.4.2',
				'depends'                  => 'BuddyPress (>=1.5)',
		...
		call_user_func(
			...
			array(
				...
				'dollie_setup_name'        => __( 'Featured Content Widget', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Provides a widget that allows you to select among five different content types to feature in a widget area.', 'dollie-setup' ),
				'version'                  => '1.0.9',
		...
		call_user_func(
			...
			array(
				...
				'dollie_setup_name'        => __( 'More Privacy Options', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Adds more blog privacy options for your users.', 'dollie-setup' ),
				'version'                  => '4.6',
		...
		call_user_func(
			...
			array(
				...
				'dollie_setup_name'        => __( 'Portfolio', 'dollie-setup' ),
				'dollie_setup_description' => __( 'WordPress portfolio tools.', 'dollie-setup' ),
				'version'                  => '1.1.0',
		...
		call_user_func(
			...
			array(
				...
				'dollie_setup_name'        => __( 'Badges', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Customizable badges for your OpenLab groups.', 'dollie-setup' ),
				'version'                  => '1.0.0',
	...
	protected static function register_recommended_plugins( $instance ) {
		...
		$instance(
			array(
				...
				'type'                     => 'recommended',
				'dollie_setup_name'        => __( 'Events', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Allows your members to create a calendar for themselves and to attach specific events to groups.', 'dollie-setup' ),
				'version'                  => '1.2.0',
	...
	protected static function register_optional_plugins( $instance ) {
		...
		call_user_func(
			...
			array(
				...
				'type'                     => 'optional',
				'dollie_setup_name'        => __( 'Braille Support', 'dollie-setup' ),
				'dollie_setup_description' => __( 'An addon for the Braille plugin providing support for BuddyPress Group Forums and Private Messaging', 'dollie-setup' ),
				'version'                  => '0.2.0',
	...
	protected static function register_installonly_plugins( $instance ) {
		call_user_func(
			...
			array(
				...
				'type'                     => 'install-only',
				'dollie_setup_name'        => __( 'Anthologize', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Create ebooks from your blog posts or other external content.', 'dollie-setup' ),
				'version'                  => '0.8.0',
		...
		call_user_func(
			...
			array(
				'plugin_name'              => 'Braille',
				'type'                     => 'install-only',
				'dollie_setup_name'        => __( 'Braille', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Provides a number of Braille-related services to WordPress.', 'dollie-setup' ),
				'documentation_url'        => 'https://wordpress.org/plugins/braille',
			)
		);
		...
		call_user_func(
			...
			array(
				...
				'type'                     => 'install-only',
				'dollie_setup_name'        => __( 'PressForward', 'dollie-setup' ),
				'dollie_setup_description' => __( 'A plugin providing an editorial workflow for content aggregation and curation within the WordPress dashboard. Designed for bloggers and editorial teams wishing to collect, discuss, and share content from a variety of sources on the open web.', 'dollie-setup' ),
				'version'                  => '5.2.8',
		...
		call_user_func(
			...
			array(
				...
				'type'                     => 'install-only',
				'dollie_setup_name'        => __( 'Attributions', 'dollie-setup' ),
				'dollie_setup_description' => __( 'A plugin for creating inline attributions for site content.', 'dollie-setup' ),
				'version'                  => '2.0.0',
		...
		call_user_func(
			...
			array(
				...
				'type'                     => 'install-only',
				'dollie_setup_name'        => __( 'Private Comments', 'dollie-setup' ),
				'dollie_setup_description' => __( 'Private comments for sites in your network.', 'dollie-setup' ),
				'version'                  => '1.1.1',
		...
		call_user_func(
			...
			array(
				...
				'type'                     => 'install-only',
				'dollie_setup_name'        => __( 'WP Grade Comments', 'dollie-setup' ),
				'dollie_setup_description' => __( 'A plugin for instructors using their WordPress site in a course setting. Provides ability to give private feedback and/or grades to post authors, all without leaving the familiar commenting interface.', 'dollie-setup' ),
				'version'                  => '1.4.4',
