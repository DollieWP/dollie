...
Please create a support ticket so our team can assist you in completing your content migration.
	...
	acf_add_local_field_group(array(
		...
		'title' => '[Form] Domain Wizard',
		'fields' => array(
			array(
				'key' => 'field_5e85b02d891c2',
				'label' => 'Domain Group',
				'name' => 'domain_group',
				'type' => 'group',
				'instructions' => '',
...
[/dollie_blockquote]',
					...
					array(
						...
						'hide_admin' => 0,
						'choices' => array(
							'no' => 'No, it\'s a domain registered for this site!',
					...
					array(
						...
						'hide_admin' => 0,
						'message' => '{dollie_is_migration_complete}',
						'new_lines' => '',
						'esc_html' => 0,
					),
					array(
						'key' => 'field_5e82fbd6e3032',
						'label' => 'Have you moved over your files/database via our Dollie Site Migration plugin at least once?',
						'name' => 'is_data_moved',
						'type' => 'radio',
						'instructions' => '',
						'required' => 1,
				...
				2. Please keep the Site Migration Plugin installed and active on your current live website. <br>
				3. At a later stage during this wizard we will sync your existing content/database one final time.
					...
					array(
						...
						'label' => 'Migration Installation Instructions',
						'name' => '',
						'type' => 'message',
						'instructions' => '',
						'required' => 0,
						...
						'hide_admin' => 0,
						'message' => '<div class="box-light padding-half">
<h3>Please do a initial content migration first!</h3>

<a target="_blank" href="http://wefoster.helpscoutdocs.com/article/59-migrating-your-content-with-the-wefoster-automated-site-migration-plugin">http://wefoster.helpscoutdocs.com/article/59-migrating-your-content-with-the-wefoster-automated-site-migration-plugin</a><br><br>

Once you are done please come back to this form and continue! 
</div>',
						'new_lines' => '',
						'esc_html' => 0,
					),
...
<strong>Go ahead, register your domain and come back to this form to continue the domain setup!</strong>
			...
			array(
				...
				'sub_fields' => array(
					...
					array(
						'key' => 'field_5e847ccf95de3',
						'label' => 'Domain connected',
						'name' => 'domain_connected',
						'type' => 'calculated',
						'instructions' => '',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
							'class' => 'acf-hide-title acf-opacity-1',
							'id' => '',
						),
						'hide_admin' => 0,
					),
					array(
						'key' => 'field_5e8480b6eff0c',
...
<a target="_blank" href="https://support.cloudflare.com/hc/en-us/articles/200167836-Where-do-I-find-my-Cloudflare-API-key-">Please visit the following page to find instructions on getting your CloudFlare API key</a>
			...
			array(
				...
				'sub_fields' => array(
					...
					array(
						'key' => 'field_5e84877a868ef',
						'label' => 'Cloudflare successfully linked',
						'name' => 'cloudflare_successfully_linked',
						'type' => 'calculated',
						'instructions' => '',
						'required' => 0,
						'conditional_logic' => array(
					...
					array(
						'key' => 'field_5e84940335a43',
						'label' => 'Finding Your Zone ID',
						'name' => 'finding_your_zone_id',
						'type' => 'calculated',
						'instructions' => '',
						'required' => 0,
						'conditional_logic' => array(
					...
					array(
						'key' => 'field_5e84c04315418',
						'label' => 'No analytics available',
						'name' => '',
						'type' => 'message',
						'instructions' => '',
						'required' => 0,
						...
						'hide_admin' => 0,
						'message' => 'Analytics are available only when setting up Cloudflare. You can <strong>continue</strong> or go back and setup Cloudflare so we can also monitor threats and search engine crawlers.',
						'new_lines' => '',
						'esc_html' => 0,
					),
				),
			...
			array(
				...
				'hide_admin' => 0,
				'message' => 'Great job! Now we\'ll just have to wait until the DNS changes take effect. This usually takes anywhere between a couple of minutes to one hour. The easiest way to check if your DNS has been updated is to go here:
<br><br>
<a target="_blank" href="https://mxtoolbox.com/DNSLookup.aspx">DNS Check Tool</a>',
				'new_lines' => '',
				'esc_html' => 0,
			),
			array(
				'key' => 'field_5e84977d1eeec',
				'label' => 'Is your domain name pointing to your WordPress installation?',
				'name' => 'is_domain_pointing',
				'type' => 'radio',
				'instructions' => 'When you visit your custom domain URL ("yourdomain.com") does it redirect you to your site on our platform? 
<br><br>
<strong>Sometimes you might see a SSL certificate error/warning, this means the DNS has updated and you can safely continue with the setup.</strong>.',
				'required' => 0,
				'conditional_logic' => array(
					array(
						array(
				...
				'choices' => array(
					'yes' => 'Yes, it does!',
					'no' => 'No, the DNS changes do not take affect',
				),
				'allow_null' => 0,
				'other_choice' => 0,
				'default_value' => '',
			...
			array(
				'key' => 'field_5e8497d91eeed',
				'label' => 'Let\'s Get Things Right',
				'name' => '',
				'type' => 'message',
				'instructions' => '',
				'required' => 0,
				...
				'hide_admin' => 0,
				'message' => '<div class="box-light padding-half">
<h3>Let\'s get things right!</h3>

We\'ve written a step-by-step guide to resolve common DNS issues that in most cases will help you quickly figure out the issue.
<a target="_blank" href="http://wefoster.helpscoautdocs.com/article/42-common-issues-with-dns-configuration">See our "Common DNS Issues and how to fix them!" article!</a> 
</div>',
				'new_lines' => 'wpautop',
				'esc_html' => 0,
			),
			array(
				'key' => 'field_5e84983842479',
...
<a target="_blank" href="http://wefoster.helpscoautdocs.com/article/42-common-issues-with-dns-configuration">See our "Common DNS Issues and how to fix them!" article!</a> 
			...
			array(
				...
				'label' => 'Does your live domain have www. in the URL?',
				'name' => 'domain_with_www',
				'type' => 'radio',
				'instructions' => 'When you visit your domain does it show <strong>www.</strong> in the address bar?',
				'required' => 1,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
...
The recommended domain setup these days is to remove <em>www.</em> from the URL. So we will continue setting up your domain without the www. prefix.
			...
			array(
				...
				'hide_admin' => 0,
				'message' => 'We\'re now updating your domain!',
				'new_lines' => '',
				'esc_html' => 0,
			),
			array(
			...
			array(
				...
				'hide_admin' => 0,
				'message' => 'Please create a support ticket so our migration team can get to the bottom of this!',
				'new_lines' => '',
				'esc_html' => 0,
			),
			array(
				...
				'hide_admin' => 0,
				'message' => '<div class="box-light padding-half">
<h3>Please wait a few more minutes...</h3>
If you have a large database the update might take a while. Please hold on a couple of minutes and if nothing has changed please get in touch with our support team so we can look into the issue.
</div>',
				'new_lines' => '',
				'esc_html' => 0,
			),
		...
		'location' => array(
			array(
				array(
					'param' => 'af_form',
					'operator' => '==',
					'value' => 'form_dollie_domain_wizard',
				),
			),
		),
		'menu_order' => 0,
