...
add_filter('af/field/prefill_value/name=site_name', 'prefill_form_field', 10, 4);

function prefill_description_field($value, $field, $form, $args)
{
	return 'The best website in the world?';
}

add_filter('af/field/prefill_value/name=site_description', 'prefill_description_field', 10, 4);

function prefill_site_name_field($value, $field, $form, $args)
{
	return 'My New Site';
}

add_filter('af/field/prefill_value/name=site_name', 'prefill_site_name_field', 10, 4);

function prefill_site_admin_user_field($value, $field, $form, $args)
{
...
add_filter('af/field/prefill_value/name=admin_username', 'prefill_site_admin_user_field', 10, 4);

function prefill_site_admin_email_field($value, $field, $form, $args)
{
	$user_info = get_userdata(get_current_user_id());
...
add_filter('af/field/prefill_value/name=admin_email', 'prefill_site_admin_email_field', 10, 4);
add_filter('af/field/prefill_value/name=site_admin_email', 'prefill_site_admin_email_field', 10, 4);
