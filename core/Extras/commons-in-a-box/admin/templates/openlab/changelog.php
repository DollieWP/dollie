		...
		<div class="wrap about-wrap">
			<h1><?php printf( __( 'Welcome to Dollie Setup OpenLab %s', 'commons-in-a-box' ), dollie_setup_get_version() ); ?></h1>
			...
			<div class="return-to-dashboard">
				<?php printf( __( '<a href="%s">Return to the DOLLIE_SETUP dashboard &rarr;</a>', 'commons-in-a-box' ), self_admin_url( 'admin.php?page=dollie_setup' ) ); ?>
			</div>
