					...
					<div>
						...
						<?php if (cbox_get_theme_prop('name', $_GET['cbox-package-details'])) : ?>
							...
							<?php if (cbox_get_theme_prop('screenshot_url', $_GET['cbox-package-details'])) : ?>
								<a class="thickbox" title="<?php esc_html_e('Screenshot of theme', 'commons-in-a-box'); ?>" href="<?php echo esc_url(cbox_get_theme_prop('screenshot_url', $_GET['cbox-package-details'])); ?>" style="float:right; margin-left:2em;"><img width="200" src="<?php echo esc_url(cbox_get_theme_prop('screenshot_url', $_GET['cbox-package-details'])); ?>" alt="" /></a>
							<?php endif; ?>
