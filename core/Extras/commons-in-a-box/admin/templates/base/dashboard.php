<?php cbox_get_template_part('wrapper-header'); ?>
									...
									<div>
										<div class="dol-flow-root dol-mt-6">
											<ul role="list" class="dol--my-5 dol-divide-y dol-divide-gray-200">
												...
												<?php $cbox_plugins = CBox_Plugins::get_plugins();
													...
													<li class="dol-py-4">
														<div class="dol-flex dol-items-center dol-space-x-4">
															...
															<div class="dol-flex-1 dol-min-w-0">
																<p class="dol-text-sm dol-font-medium dol-text-gray-900"><?php echo $plugin . ' <span class="dol-text-gray-400">' . $cbox_plugins[$plugin]['version'] . '</span>'; ?></p>
																<p class="dol-text-sm dol-text-gray-500"><?php echo $cbox_plugins[$plugin]['cbox_description']; ?></p>
															</div>
															<div>
...
<?php cbox_get_template_part('wrapper-footer'); ?>
