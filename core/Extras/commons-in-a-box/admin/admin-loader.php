...
?>
	...
	?>
		...
		<style type="text/css">
			/* Plugin row */
			.row-actions-visible .plugin-card {
				width: 100%;
				padding: 0px 8px;
				margin: 0;
			}

			.row-actions-visible .plugin-card .update-now {
				line-height: 1.8;
			}
			...
			#adminmenu #toplevel_page_cbox.wp-has-current-submenu .wp-menu-image {
				background-position: 4px -1px;
			}

			#toplevel_page_cbox .wp-menu-image img {
				display: none;
			}

			.cbox-admin-wrap .nav-tab:first-child {
				margin-left: 0;
			}

			.cbox-admin-wrap .nav-tab-active {
				background: #fff;
			...
			.cbox-admin-content.has-top-border {
	...
	?>
		...
		<style type="text/css">
			...
			.plugin-card-OpenLab .column-description {
				min-height: 140px;
			}

			.plugin-card .theme-required:before,
			.plugin-card .theme-optional:before {
				margin-top: -1px;
				margin-left: -5px;
			}
			...
			#getting-started li:nth-child(even) {
				left: 40px;
			}
			...
			#getting-started .inside h4 {
				margin: 0;
			}

			#getting-started .inside h4 a {
				text-decoration: none;
				font-size: 1.3em;
			}
			...
			#wpbody .login .message {
				margin: 15px 0;
				text-align: center;
			}

			.login .message a.button-secondary {
				display: inline-block;
				margin: 10px 0 0;
			}
			...
			.getting-started-cbox-classic h4 .icon16 {
				margin-top: -12px;
				margin-left: -32px;
			}
			...
			.metabox-holder .welcome-panel-last {
				margin-right: 0;
			}
			...
			.cbox-plugins-section .check-column {
				padding: 10px 0 0;
			}

			.cbox-plugins-section h3 {
				font-size: 1.15em;
			}

			.cbox-plugins-section table {
				margin: 1.6em 0;
			}

			tr.cbox-plugin-row-active th,
			tr.cbox-plugin-row-active td {
				background-color: rgb(249, 255, 240);
			}

			tr.cbox-plugin-row-action-required th,
			tr.cbox-plugin-row-action-required td {
				background-color: #F4F4F4;
			}

			tr.cbox-plugin-network-active p {
				color: #333;
			}

			.column-cbox-plugin-name {
				width: 220px;
			}
			...
			.cbox-admin-content .cbox-plugins-section {
				padding-left: 5px;
				padding-right: 5px;
			}

			.cbox-admin-content .cbox-plugins-section:first-child {
				padding-top: 0;
			}

			.cbox-admin-content .cbox-plugins-section:first-child h2 {
				margin-top: 0;
			}

			.cbox-admin-content .cbox-plugins-section:last-of-type {
				border: 0;
				padding-bottom: 0;
			}
