	...
	acf_add_local_field_group(
		array(
            ...
            Follow along with the <a target="_blank" href="https://partners.getdollie.com/?redirect=knowledge-base/domain-setup/">Domain Setup Guide</a> in the partner dashboard to have your domain added in no time, without any hassle.',
				...
				array(
					'key'               => 'field_61261757483f4',
					'label'             => __( 'Performance Settings', 'dollie' ),
					'name'              => '',
					'type'              => 'message',
					'instructions'      => '',
					'required'          => 0,
				...
				array(
					'key'               => 'field_6126147fc0a77',
					'label'             => __( 'Site Dashboard Refresh Time', 'dollie' ),
					'name'              => 'wpd_site_refresh_time',
					'type'              => 'select',
					'instructions'      => __( 'When one of your customers visits their site dashboard it fetches the data from their WordPress installation. By default this data is updated every 15 minutes. If your customers are using your dashboard heavily to update plugins/themes, we recommend to set this to a shorter time.', 'dollie' ),
					'required'          => 0,
					'conditional_logic' => 0,
					'wrapper'           => array(
						'width' => '',
