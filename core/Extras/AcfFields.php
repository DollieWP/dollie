...
if ( function_exists( 'acf_add_local_field_group' ) ) :
		...
		array(
			...
			'fields'                => array(
				array(
					...
					'label'             => 'Would you like to charge customers/clients for launching sites?',
					'name'              => 'wpd_charge_for_deployments',
					'type'              => 'true_false',
					'instructions'      => sprintf(
						esc_html__( 'If you are building a WaaS or SaaS platform or are an Agency that wants to bill your clients through your Hub, enable this feature', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_plural_string(),
						dollie()
							->string_variants()
							->get_site_type_plural_string(),
					),
					...
					'default_value'     => 1,
					'ui'                => 1,
					'ui_on_text'        => 'Enable Billing Features',
					'ui_off_text'       => 'Disable Billing Features',
				),
				array(
					'key'                      => 'field_649b11f5400e8',
					'label'                    => __( 'Wizard Complete', 'dollie' ),
					'name'                     => 'wpd_wizard_completed',
					'aria-label'               => '',
					'type'                     => 'acfe_hidden',
					'instructions'             => '',
					'required'                 => 0,
		...
		array(
			...
			'fields'                => array(
				...
				array(
					...
					'choices'           => array(
						'screenshot' => 'Site Screenshot - updates automatically)',
						'theme'      => 'Active Theme Screenshot - screenshot.png from active theme)',
	...
	acf_add_local_field_group(
		array(
			...
			'fields'                => array(
				...
				array(
					'key'               => 'field_612616deewrewrc4regre8sf3f2',
					'label'             => __( 'Your Hub Configuration', 'dollie' ),
					'name'              => '',
					'type'              => 'message',
					'instructions'      => '',
					'required'          => 0,
					...
					'hide_admin'        => 0,
					'message'           => __( 'Start by configuring the core features of your Hub and review them carefully.', 'dollie' ),
					'new_lines'         => 'wpautop',
					'esc_html'          => 0,
				),
				...
				array(
					...
					'hide_admin'        => 0,
					'message'           => __( 'This is the domain used for the sites launched by your customers.', 'dollie' ),
					'new_lines'         => 'wpautop',
					'esc_html'          => 0,
				),
				array(
					...
					'type'              => 'select',
					'choices'           => array(),
					'instructions'      => __( sprintf('<strong>Please select the domain you like to use for your Hub.</strong> You can add your own domain(s) easily via <a target="_blank" href="%s">Control HQ</a>.', 'dollie' ), 'https://control.getdollie.com'),
					'required'          => 1,
					'conditional_logic' => 0,
					'wrapper'           => array(
						'width' => '',
				...
				array(
					...
					'label'             => __( 'Monetisation Settings', 'dollie' ),
					'name'              => '',
					'type'              => 'message',
					'instructions'      => '',
					'required'          => 0,
				...
				array(
					'key'               => 'field_5e2eb1ca86e3d',
					'label'             => 'Enable Payment/Subscription Features',
					'name'              => 'wpd_charge_for_deployments',
					'type'              => 'true_false',
					'instructions'      => sprintf(
						esc_html__( 'Would you like to charge your customers for features like launching %1$s or access to certain features? If you are building a WaaS or SaaS platform we recommend that you turn this feature on. If you set this to "off" anyone can use all the features on your platform. This can be useful if you use the Hub only for your team or if you run an Agency and want to give your clients the option to launch sites on their own on your platform.', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_plural_string(),
						dollie()
				...
				array(
					'key'                      => 'field_6491ebb288e52',
					'label'                    => __( 'Checkout - Override Thank You Page', 'dollie' ),
					'name'                     => 'wpd_override_thank_you_page',
					'aria-label'               => '',
					'type'                     => 'true_false',
					'instructions'             => __( 'If enabled this will redirect the client to dollie launch site page and show a success message. Applies only when launching sites based on a blueprint', 'dollie' ),
					'required'                 => 0,
					'conditional_logic'        => array(
						array(
							array(
				...
				array(
					'key'               => 'field_612616deewrereferfwrc4regre83f2',
					'label'             => __( 'These Hub pages are created automatically', 'dollie' ),
					'name'              => '',
					'type'              => 'message',
					'instructions'      => '',
					'required'          => 0,
					...
					'hide_admin'        => 0,
					'message'           => __( 'You can customise them using a pagebuilder of choice and/or import pre-made Hub designs easily.', 'dollie' ),
					'new_lines'         => 'wpautop',
					'esc_html'          => 0,
				),
				array(
					'key'               => 'field_61eed2616dc483f2',
					'label'             => __( 'Core Hub Pages', 'dollie' ),
					'name'              => '',
					'type'              => 'message',
					'instructions'      => '',
					'required'          => 0,
				...
				array(
					...
					'label'             => sprintf(
						esc_html__( 'Launch New %s Page', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_string(),
					),
					'name'              => 'wpd_launch_page_id',
					'type'              => 'post_object',
					'instructions'      => sprintf(
						esc_html__( 'This page contains the template for launching a new %s', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_string(),
					),
				...
				array(
					...
					'label'             => __( 'Launch New Blueprint', 'dollie' ),
				...
				array(
					'key'               => 'field_61eed2616dedeweffefc483f2',
					'label'             => __( 'Admin Hub Pages (only visible for Admins)', 'dollie' ),
					'name'              => '',
					'type'              => 'message',
					'instructions'      => '',
					'required'          => 0,
					...
					'hide_admin'        => 0,
					'message'           => __( 'These can be optionally assigned.', 'dollie' ),
					'new_lines'         => 'wpautop',
					'esc_html'          => 0,
				),
				array(
				...
				array(
					'key'               => 'field_61eed2616defefc483f2',
					'label'             => __( 'Optional Hub Pages', 'dollie' ),
					'name'              => '',
					'type'              => 'message',
					'instructions'      => '',
					'required'          => 0,
				...
				array(
					...
					'type'              => 'post_object',
					'instructions'      => __( 'If you would like to show a seperate page when someone launches a site, you can assign it below. Once a customer has launched a site they will be redirected to this page. After the site is launched they will then be redirected to the Site Dashboard.', 'dollie' ),
					'required'          => 0,
					'conditional_logic' => 0,
					'wrapper'           => array(
						'width' => '',
            ...
            This is the default screenshot image shown until a live screenshot is generated.',
				...
				array(
					...
					'name'              => '',
					'type'              => 'tab',
					'instructions'      => 'These are the default features in your Hub that are available for all your customers.',
					'required'          => 0,
					'conditional_logic' => 0,
					'wrapper'           => array(
						'width' => '',
				...
				array(
					'key'               => 'field_612616deewrewrc4regre83f2',
					'label'             => __( 'These are the default features in your Hub that are available for all your customers.', 'dollie' ),
					'name'              => '',
					'type'              => 'message',
					'instructions'      => '',
					'required'          => 0,
					...
					'hide_admin'        => 0,
					'message'           => __( 'Please use Access Groups if you would like to enable/disable specific Hub Features or monetize access to them.', 'dollie' ),
					'new_lines'         => 'wpautop',
					'esc_html'          => 0,
				),
				array(
					'key'               => 'field_612616dc4regre83f2',
					'label'             => __( 'Default Site Dashboard Features', 'dollie' ),
					'name'              => '',
					'type'              => 'message',
					'instructions'      => '',
					'required'          => 0,
				...
				array(
					...
					'label'             => sprintf(
						esc_html__( 'Enable %1$s Dashboard for %2$s', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_string(),
						dollie()
							->string_variants()
							->get_user_type_plural_string(),
					),
					'name'              => 'wpd_allow_site_dashboard_access',
					'type'              => 'true_false',
					'instructions'      => sprintf(
						esc_html__( 'Would you like to give your %1$s the ability to manage their own %2$s or would you like to restrict this functionality to your team only?', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_user_type_plural_string(),
						dollie()
				...
				array(
					...
					'label'             => sprintf(
						esc_html__( '%s Dashboard Features', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_string(),
					),
					...
					'type'              => 'checkbox',
					'instructions'      => sprintf(
						esc_html__( 'Depending on the type of %1$s you focus on, you can choose to disable certain (advanced) features of the %2$s Dashboard.', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_user_type_plural_string(),
						dollie()
				...
				array(
					...
					'type'              => 'checkbox',
					'instructions'      => sprintf(
						esc_html__( 'Disable certain (advanced) features of the %s Developer Tools.', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_string(),
					),
				...
				array(
					'key'               => 'field_612616dc4regewfre83f2',
					'label'             => __( 'Default Role', 'dollie' ),
					'name'              => '',
					'type'              => 'message',
					'instructions'      => '',
					'required'          => 0,
				...
				array(
					...
					'label'             => sprintf(
						esc_html__( 'Default %1$s Role for Launched %2$s', 'dollie-setup' ),
						dollie()
							->string_variants()
				...
				array(
					...
					'label'             => __( 'Hub Admin Settings', 'dollie' ),
					'name'              => '',
					'type'              => 'message',
					'instructions'      => '',
					'required'          => 0,
				...
				array(
					...
					'label'             => sprintf(
						esc_html__( 'View All %s', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_plural_string(),
					),
					...
					'type'              => 'checkbox',
					'instructions'      => sprintf(
						esc_html__( 'Grant specific User Roles the VIEW permission on all %s', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_plural_string(),
					),
				...
				array(
					...
					'label'             => sprintf(
						esc_html__( 'Manage All %s', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_plural_string(),
					),
					...
					'type'              => 'checkbox',
					'instructions'      => sprintf(
						esc_html__( 'Grant specific User Roles the ability to VIEW and MANAGE all %s', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_plural_string(),
					),
				...
				array(
					...
					'label'             => sprintf(
						esc_html__( 'Delete %s', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_plural_string(),
					),
					...
					'type'              => 'checkbox',
					'instructions'      => sprintf(
						esc_html__( 'Grant specific User Roles the ability to DELETE %s', 'dollie-setup' ),
						dollie()
							->string_variants()
							->get_site_type_plural_string(),
					),
            ...
            {dollie_site_url}, {dollie_site_name}, {dollie_user}, {dollie_site_email}, {dollie_site_username}, {dollie_site_password}',
					...
					'hide_admin'        => 0,
					'default_value'     => 'Hi,
            Site <a href="{dollie_site_url}">{dollie_site_name}</a> has been launched successfully. Here are the login details.<br> <br>Email: {dollie_site_email}<br>
			Default password: {dollie_site_password}<br><br>
			',
					'tabs'              => 'all',
					'toolbar'           => 'full',
					'media_upload'      => 1,
				...
				array(
					...
					'hide_admin'        => 0,
					'default_value'     => 'A new site has been launch from your Hub',
					'placeholder'       => '',
					'prepend'           => '',
					'append'            => '',
					'maxlength'         => '',
    ...
    {dollie_sites_stopped_count}, {dollie_sites_removal_count}',
					...
					'hide_admin'        => 0,
					'default_value'     => 'Your Hub Update - {dollie_sites_stopped_count} will be stopped, {dollie_sites_removal_count} will be completely removed',
					'placeholder'       => '',
					'prepend'           => '',
					'append'            => '',
					'maxlength'         => '',
		...
		array(
			...
			'fields'                => array(
				...
				array(
					...
					'label'                    => __( 'Choose your page builder  ', 'dollie' ),
					'name'                     => 'wpd_choose_builder',
					'aria-label'               => '',
					'type'                     => 'radio',
					'instructions'             => __( 'What builder are you using to edit Dollie specific pages.', 'dollie' ),
					'required'                 => 0,
					'wrapper'                  => array(
						'width' => '',
						'class' => '',
					...
					'hide_admin'               => 0,
					'choices'                  => array(
						'gutenberg'          => '<span>Gutenberg</span><img style="width:128px" src="https://ps.w.org/gutenberg/assets/icon-256x256.jpg">',
						'elementor' => '<span>Elementor</span><img style="width:128px" src="https://elementor.com/marketing/wp-content/uploads/2021/10/Elementor-Logo-Symbol-Red.png">',
					),
				...
				array(
					...
					'sub_fields'               => array(
						...
						array(
							...
							'instructions'             => __(
								'For example "name".
Populated with yoursite.com/launch-site/?name=John',
								'dollie',
							),
							'required'                 => 0,
							'conditional_logic'        => array(
