	...
	acf_add_local_field_group( [
		...
		'fields'                => [
			...
			[
				...
				'aria-label' => '',
				'type' => 'true_false',
				'instructions' => __('If enabled this will redirect the client to dollie launch site page and shown a success message. Applies only when launching sites based on a blueprint', 'dollie'),
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
