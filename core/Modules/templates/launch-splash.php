<script type="text/javascript">
    jQuery(document).ready(function($) {
        var field = $('.site-blueprints');
        <?php if (isset($_COOKIE['dollie_blueprint_id'])) : ?>
            field.addClass("hidden");
        <?php endif; ?>
        if ($('.site-blueprint li').length === 0) {
            field.addClass("hidden");
        }

        $(".dollie-launch-url .ginput_container").append("<span class='domain-suffix'><strong><?php echo DOLLIE_DOMAIN; ?></strong></span>");
    });
</script>

<div data-backdrop="static" data-keyboard="false" class="modal" id="modal-large" tabindex="-1" role="dialog" aria-labelledby="modal-large" style="display: none;" aria-hidden="true">
