<div class="blockquote-box blockquote-success clearfix">
    ...
    <h4>
		<?php _e( 'Final Step: Updating Your WordPress URL!', 'dollie' ); ?>
    </h4>
    <p>
		<?php
		...
		?>
        <br><br>
		<?php _e( 'Just click on "Update My Domain" and our migration minions will do all the heavy lifting behind the scenes.', 'dollie' ); ?>
    </p>
</div>
