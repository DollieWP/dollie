...
function dollie_show_container_manager_link($field)
{
	...
	<div style="margin-left: 0; z-index: 0" class="dollie-notice">
		<div class="dollie-inner-message">
			...
			<div class="dollie-message-center">
				...
				<p><a href="<?php echo $dashboard_url . '/adminUISites/show/' . $container_id; ?>">Visit the Dollie Container Manager to quicky start/stop/restart this site and access other advanced management tools</a></p>
			</div>
		</div>
	</div>
<?php $link = ob_get_clean();
	$field['message'] = str_replace(
		['%dollie_container_message%'],
		$link,
		$field['message']
	);
	return $field;
}
add_filter('acf/load_field/type=message', 'dollie_show_container_manager_link');
