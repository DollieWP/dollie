					...
					<div class="dollie-inner-message">
						...
						<div class="dollie-message-center">
							...
							<p>
								...
								echo wp_kses_post(
									sprintf(
										__('<strong>Dollie</strong> needs to update some of it\'s settings that are used behind the scenes. It
									\'ll only take a second to complete. ', 'dollie'),
										esc_url($url)
									)
								);
								?>
