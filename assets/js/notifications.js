...
(function ($) {
    ...
    Dollie.notifications = {
        ...
        refreshID: null,
        refreshTime: (wpdNotifications.hasOwnProperty('refreshTime') && wpdNotifications.refreshTime !== '0') ? wpdNotifications.refreshTime : 20000,
        ...
        markAsRead: function () {
            ...
            var _this = this;
            var values = 'action=dollie_notifications_mark_read&check=' + $(_this.selectors.list).data('nonce');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.success === true) {
                        $('.notif-item.notif-unread').removeClass('notif-unread').addClass('notif-read');
        ...
        registerAjaxInterval: function () {
            ...
            _this.refreshID = setInterval(function () {
                ...
                var values = 'action=dollie_get_notifications&check=' + $(_this.selectors.list).data('nonce');
                values += '&current_notifications=' + $(_this.selectors.count).first().text();
